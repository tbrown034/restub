// TEST DATABASE CONNECTION PAGE - DISABLED FROM PUBLIC VIEW
// This page is kept for development purposes but disabled from production
...
// Return a simple 404 page when accessed
export default function TestDbPage() {
  return (
