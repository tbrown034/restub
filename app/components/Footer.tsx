        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-orange-600 border border-gray-700 hover:border-orange-700 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors duration-200 hover:translate-x-1 inline-block">Features</a></li>
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors duration-200 hover:translate-x-1 inline-block">Pricing</a></li>
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors duration-200 hover:translate-x-1 inline-block">API</a></li>
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors duration-200 hover:translate-x-1 inline-block">Integrations</a></li>
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors duration-200 hover:translate-x-1 inline-block">Changelog</a></li>
            </ul>
          </div>
